...
def generate_signal_258(duration=1.0, sample_rate=1000):
    """테스트 신호 생성 #258"""
...
def analyze_258(signal, sample_rate=1000):
    """주파수 분석"""
...
if __name__ == "__main__":
    t, sig = generate_signal_258()
    peak_freq, peak_mag = analyze_258(sig)
    print(f"실험 #258")
