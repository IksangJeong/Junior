...
def generate_signal_238(duration=1.0, sample_rate=1000):
    """테스트 신호 생성 #238"""
...
def analyze_238(signal, sample_rate=1000):
    """주파수 분석"""
...
if __name__ == "__main__":
    t, sig = generate_signal_238()
    peak_freq, peak_mag = analyze_238(sig)
    print(f"실험 #238")
