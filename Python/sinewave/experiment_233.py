...
def generate_signal_233(duration=1.0, sample_rate=1000):
    """테스트 신호 생성 #233"""
...
def analyze_233(signal, sample_rate=1000):
    """주파수 분석"""
...
if __name__ == "__main__":
    t, sig = generate_signal_233()
    peak_freq, peak_mag = analyze_233(sig)
    print(f"실험 #233")
