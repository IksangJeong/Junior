...
def detect_outliers_445(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(445)
    data = np.random.randn(4500, 3)
    # 이상치 추가
    data[5] = [8, 8, 8]

    stats = analyze_dataset_445(data)
    print(f"분석 #445")
    ...
    outliers = detect_outliers_445(data)
