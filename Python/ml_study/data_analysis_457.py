...
def detect_outliers_457(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(457)
    data = np.random.randn(4620, 3)
    # 이상치 추가
    data[7] = [10, 10, 10]

    stats = analyze_dataset_457(data)
    print(f"분석 #457")
    ...
    outliers = detect_outliers_457(data)
