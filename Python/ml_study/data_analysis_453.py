...
def detect_outliers_453(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(453)
    data = np.random.randn(4580, 2)
    # 이상치 추가
    data[3] = [11, 11]

    stats = analyze_dataset_453(data)
    print(f"분석 #453")
    ...
    outliers = detect_outliers_453(data)
