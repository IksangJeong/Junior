...
if __name__ == "__main__":
    ...
    true_weights = np.array([1.4, 2.81, 2.31])
    y = X @ true_weights + -0.01 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_446(n_features)
