...
def detect_outliers_443(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(443)
    data = np.random.randn(4480, 4)
    # 이상치 추가
    data[3] = [11, 11, 11, 11]

    stats = analyze_dataset_443(data)
    print(f"분석 #443")
    ...
    outliers = detect_outliers_443(data)
