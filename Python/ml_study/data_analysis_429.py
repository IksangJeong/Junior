...
def detect_outliers_429(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(429)
    data = np.random.randn(4340, 2)
    # 이상치 추가
    data[9] = [12, 12]

    stats = analyze_dataset_429(data)
    print(f"분석 #429")
    ...
    outliers = detect_outliers_429(data)
