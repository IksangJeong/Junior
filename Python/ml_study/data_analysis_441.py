...
def detect_outliers_441(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(441)
    data = np.random.randn(4460, 2)
    # 이상치 추가
    data[1] = [9, 9]

    stats = analyze_dataset_441(data)
    print(f"분석 #441")
    ...
    outliers = detect_outliers_441(data)
