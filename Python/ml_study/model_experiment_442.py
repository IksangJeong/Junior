...
if __name__ == "__main__":
    ...
    true_weights = np.array([2.34, 0.68, -0.86, 0.99])
    y = X @ true_weights + 0.63 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_442(n_features)
