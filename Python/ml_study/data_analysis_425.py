...
def detect_outliers_425(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(425)
    data = np.random.randn(4300, 4)
    # 이상치 추가
    data[5] = [8, 8, 8, 8]

    stats = analyze_dataset_425(data)
    print(f"분석 #425")
    ...
    outliers = detect_outliers_425(data)
