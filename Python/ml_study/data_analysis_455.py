...
def detect_outliers_455(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(455)
    data = np.random.randn(4600, 4)
    # 이상치 추가
    data[5] = [8, 8, 8, 8]

    stats = analyze_dataset_455(data)
    print(f"분석 #455")
    ...
    outliers = detect_outliers_455(data)
