...
if __name__ == "__main__":
    ...
    true_weights = np.array([1.0, -2.49, -0.94, 0.25, 2.82, 0.54])
    y = X @ true_weights + 0.11 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_454(n_features)
