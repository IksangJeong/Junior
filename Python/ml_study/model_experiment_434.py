...
if __name__ == "__main__":
    ...
    true_weights = np.array([-0.09, 2.48, 0.01, -0.67, -1.92, -1.09])
    y = X @ true_weights + -0.56 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_434(n_features)
