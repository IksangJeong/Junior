...
def detect_outliers_433(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(433)
    data = np.random.randn(4380, 3)
    # 이상치 추가
    data[3] = [11, 11, 11]

    stats = analyze_dataset_433(data)
    print(f"분석 #433")
    ...
    outliers = detect_outliers_433(data)
