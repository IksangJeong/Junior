...
if __name__ == "__main__":
    ...
    true_weights = np.array([-1.35, -2.14, 0.65, 1.16])
    y = X @ true_weights + -0.92 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_462(n_features)
