...
def detect_outliers_449(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(449)
    data = np.random.randn(4540, 4)
    # 이상치 추가
    data[9] = [12, 12, 12, 12]

    stats = analyze_dataset_449(data)
    print(f"분석 #449")
    ...
    outliers = detect_outliers_449(data)
