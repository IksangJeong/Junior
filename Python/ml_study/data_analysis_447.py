...
def detect_outliers_447(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(447)
    data = np.random.randn(4520, 2)
    # 이상치 추가
    data[7] = [10, 10]

    stats = analyze_dataset_447(data)
    print(f"분석 #447")
    ...
    outliers = detect_outliers_447(data)
