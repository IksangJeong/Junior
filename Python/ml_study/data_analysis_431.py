...
def detect_outliers_431(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(431)
    data = np.random.randn(4360, 4)
    # 이상치 추가
    data[1] = [9, 9, 9, 9]

    stats = analyze_dataset_431(data)
    print(f"분석 #431")
    ...
    outliers = detect_outliers_431(data)
