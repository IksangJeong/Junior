...
def detect_outliers_461(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(461)
    data = np.random.randn(4660, 4)
    # 이상치 추가
    data[1] = [9, 9, 9, 9]

    stats = analyze_dataset_461(data)
    print(f"분석 #461")
    ...
    outliers = detect_outliers_461(data)
