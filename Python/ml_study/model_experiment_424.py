...
if __name__ == "__main__":
    ...
    true_weights = np.array([2.11, 2.56, -0.64, 1.99, -1.04, -0.28])
    y = X @ true_weights + -0.53 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_424(n_features)
