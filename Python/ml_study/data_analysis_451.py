...
def detect_outliers_451(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(451)
    data = np.random.randn(4560, 3)
    # 이상치 추가
    data[1] = [9, 9, 9]

    stats = analyze_dataset_451(data)
    print(f"분석 #451")
    ...
    outliers = detect_outliers_451(data)
