...
def detect_outliers_437(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(437)
    data = np.random.randn(4420, 4)
    # 이상치 추가
    data[7] = [10, 10, 10, 10]

    stats = analyze_dataset_437(data)
    print(f"분석 #437")
    ...
    outliers = detect_outliers_437(data)
