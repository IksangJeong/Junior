...
if __name__ == "__main__":
    ...
    true_weights = np.array([1.49, -1.5, -0.23, 1.82, -2.16])
    y = X @ true_weights + -0.98 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_428(n_features)
