...
if __name__ == "__main__":
    ...
    true_weights = np.array([0.16, -0.81])
    y = X @ true_weights + -0.85 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_440(n_features)
