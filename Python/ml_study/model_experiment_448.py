...
if __name__ == "__main__":
    ...
    true_weights = np.array([-2.55, -1.98, -0.75, 1.39, 0.28])
    y = X @ true_weights + 0.8 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_448(n_features)
