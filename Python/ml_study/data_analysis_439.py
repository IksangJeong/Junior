...
def detect_outliers_439(data, threshold=2.5):
    """이상치 탐지"""
...
if __name__ == "__main__":
    np.random.seed(439)
    data = np.random.randn(4440, 3)
    # 이상치 추가
    data[9] = [12, 12, 12]

    stats = analyze_dataset_439(data)
    print(f"분석 #439")
    ...
    outliers = detect_outliers_439(data)
