...
if __name__ == "__main__":
    ...
    true_weights = np.array([2.98, 0.76, 2.0, -1.45, 2.46])
    y = X @ true_weights + 0.83 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_458(n_features)
