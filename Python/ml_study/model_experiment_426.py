...
if __name__ == "__main__":
    ...
    true_weights = np.array([2.11, -2.46, 1.85])
    y = X @ true_weights + -0.39 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_426(n_features)
