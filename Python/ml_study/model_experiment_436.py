...
if __name__ == "__main__":
    ...
    true_weights = np.array([-1.55, 0.2, 1.75])
    y = X @ true_weights + 0.47 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_436(n_features)
