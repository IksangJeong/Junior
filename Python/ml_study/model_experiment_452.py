...
if __name__ == "__main__":
    ...
    true_weights = np.array([-0.16, -2.31, 1.71, -0.17])
    y = X @ true_weights + 0.79 + np.random.randn(n_samples) * 0.5

    model = SimpleModel_452(n_features)
